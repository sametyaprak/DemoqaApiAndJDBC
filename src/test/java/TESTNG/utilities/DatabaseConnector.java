...
//            preparedStatement.setInt(2,1); //2. ? yerine
    ...
    public static void closeConnection() {
        ...
        if (resultSet != null) {
            try {
                System.out.println("Database Connection / resultSet kapatiliyor...");
                resultSet.close();
        ...
        if ( statement!= null) {
            try {
                System.out.println("Database Connection / statement kapatiliyor...");
                statement.close();
            } catch (SQLException ex) {
                s = false;
                ex.printStackTrace();
        ...
        if (connection != null) {
            try {
                System.out.println("Database Connection / connection kapatiliyor...");
                connection.close();
            } catch (SQLException ex) {
                c = false;
                ex.printStackTrace();
